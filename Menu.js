...
function saveOrder() {
    ...
    fetch(`https://edu.std-900.ist.mospolytech.ru/labs/api/orders/${orderId}?api_key=e69fbe1d-3d77-40c8-8f97-4dea13746819`, {
        method: 'PUT',
...
function confirmDelete() {
    ...
    fetch(`https://edu.std-900.ist.mospolytech.ru/labs/api/orders/${orderIdToDelete}?api_key=e69fbe1d-3d77-40c8-8f97-4dea13746819`, {
        method: 'DELETE'
    })
        .then(response => response.json())
        .then((data) => {
